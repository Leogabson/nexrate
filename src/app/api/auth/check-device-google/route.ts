// src/app/api/auth/check-device-google/route.ts
...
export async function POST(req: NextRequest) {
  try {
    ...
    return NextResponse.json(
      {
        ...
        redirectTo: `/auth/verify-code?email=${encodeURIComponent(
          email
        )}&returnUrl=/dashboard`,
      },
      { status: 200 }
    ...
    console.error("Check device Google error:", error);
    return NextResponse.json(
...
async function sendVerificationEmail(email: string, code: string) {
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Hello,</p>
          <p>We noticed a sign-in attempt from a new device using Google OAuth. To ensure your account's security, please verify this sign-in with the code below:</p>
          ...
          <div class="warning">
            ...
            If you didn't attempt to sign in, please secure your Google account immediately and contact NexRate support.
          </div>
  ...
  const msg = {
    ...
    subject: "New Device Sign-In (Google) - Verification Required",
    text: `We noticed a sign-in from a new device using Google. Your verification code is: ${code}. This code will expire in 5 minutes. If you didn't attempt to sign in, please secure your Google account immediately.`,
    html: emailHtml,
  };
